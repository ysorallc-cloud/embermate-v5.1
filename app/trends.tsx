...
const SAMPLE_TRENDS: TrendData[] = [
  {
    ...
    points: [
      ...
      { date: '2024-01-11', label: 'Thu', value: 5 },
      { date: '2024-01-12', label: 'Fri', value: 7 },
  ...
  },
  {
    ...
    points: [
      ...
      { date: '2024-01-11', label: 'Thu', value: 4 },
      { date: '2024-01-12', label: 'Fri', value: 6 },
  ...
  },
  {
    ...
    points: [
      ...
      { date: '2024-01-11', label: 'Thu', value: 5 },
      { date: '2024-01-12', label: 'Fri', value: 3 },
  ...
  },
  {
    ...
    points: [
      ...
      { date: '2024-01-13', label: 'Sat', value: 8 },
      { date: '2024-01-14', label: 'Sun', value: 6 },
      { date: '2024-01-15', label: 'Mon', value: 7 },
      { date: '2024-01-16', label: 'Tue', value: 8 },
    ],
    average: 6.7,
    change: 33,
    changeLabel: 'Meeting goals',
  },
  {
    id: 'medAdherence',
    title: 'Medication',
    ...
    points: [
      ...
      { date: '2024-01-11', label: 'Thu', value: 75 },
      { date: '2024-01-12', label: 'Fri', value: 100 },
      { date: '2024-01-13', label: 'Sat', value: 100 },
      { date: '2024-01-14', label: 'Sun', value: 50 },
      { date: '2024-01-15', label: 'Mon', value: 100 },
      { date: '2024-01-16', label: 'Tue', value: 100 },
    ],
    average: 89,
    change: 0,
    changeLabel: 'Weekend dips',
  },
];
