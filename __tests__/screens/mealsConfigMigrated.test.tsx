// ============================================================================
// Phase 10.3.x — meals.tsx migrated to CarePlanConfigScreen.
//
// Pre-10.3: SafeAreaView + LinearGradient wrapper, with SubScreenHeader
// providing the title and subtitle.
// Post-10.3: <CarePlanConfigScreen chrome="gradient"> owns all chrome.
// Body content (priority, meal-time grid, tracking style, notifications)
// unchanged.
// ============================================================================
...
const SRC = readFileSync(
  join(__dirname, '../..', 'app/care-plan/meals.tsx'),
  'utf8',
);
...
describe('Phase 10.3.x — meals.tsx migrated to CarePlanConfigScreen', () => {
  ...
  it('contract 4: drops legacy SafeAreaView + LinearGradient + SubScreenHeader', () => {
