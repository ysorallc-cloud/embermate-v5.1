// ============================================================================
// Phase 10.3.x — shifts.tsx migrated to CarePlanConfigScreen.
//
...
// The body (shift list + add form) is unchanged.
//
// Pinned contracts:
...
//      (the primitive owns them now).
//   5. No patient-name interpolation (audit confirmed pre-10.3 already
//      had none — pin it stays gone).
...
const SRC = readFileSync(
  join(__dirname, '../..', 'app/care-plan/shifts.tsx'),
  'utf8',
);
...
describe('Phase 10.3.x — shifts.tsx migrated to CarePlanConfigScreen', () => {
