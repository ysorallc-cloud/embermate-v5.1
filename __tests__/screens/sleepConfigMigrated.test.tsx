// ============================================================================
// Phase 10.3.x — sleep.tsx migrated to CarePlanConfigScreen.
//
// Pre-10.3: SafeAreaView + LinearGradient wrapper, hand-rolled header
// with a "SLEEP" tiny-caps banner, body-level "Sleep" title section.
//
// Post-10.3: <CarePlanConfigScreen chrome="gradient"> owns the chrome.
// Body content (priority, what-to-track, info card, notifications) is
// unchanged.
// ============================================================================
...
const SRC = readFileSync(
  join(__dirname, '../..', 'app/care-plan/sleep.tsx'),
  'utf8',
);
...
describe('Phase 10.3.x — sleep.tsx migrated to CarePlanConfigScreen', () => {
  ...
  it('contract 5: tiny-caps "SLEEP" banner is gone', () => {
    expect(codeOnly).not.toMatch(/<Text[^>]*>\s*SLEEP\s*<\/Text>/);
  });
