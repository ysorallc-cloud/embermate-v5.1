...
export const CATEGORY_CONFIG: Record<string, { label: string; chipLabel: string; color: string }> = {
  medication:  { label: 'CARE',       chipLabel: 'Meds',      color: '#5fb88a' }, // green (accent)
  vitals:      { label: 'VITALS',    chipLabel: 'Vitals',    color: '#A78BFA' }, // purple
  wellness:    { label: 'WELLNESS',  chipLabel: 'Check-ins', color: '#5fb88a' }, // green (accent)
  nutrition:   { label: 'MEAL',      chipLabel: 'Meals',     color: '#e5b04a' }, // amber
  ...
  errand:      { label: 'ERRAND',    chipLabel: 'Errands',   color: '#e5b04a' }, // amber
